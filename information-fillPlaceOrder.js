                                ...
                                $("#goodstype").text(goodsTypes[0]);
                                 for (var i in data2) {
                                   if(Array.isArray(data2[i])){
                                     var m;
                                     if(data2[i].every(function(item,index){ m= index; return item.status != "1"})){}else {
          ...
          initselectDateEvent: function(data2) {
              ...
              myBtn.click(function() {
               ...
               // }, false);
                  ...
                  for (var i in data2) {
                    if(Array.isArray(data2[i])){
                     if(data2[i].every(function(item){ return item.status != "1"})){}else {
                      var temp = (i == "TDY" ? "今天" : (i == "TOM" ? "明天" : "后天"));
                      date2.push({
                          "id": k.toString(),
                          "value": temp,
                 ...
                 var tempData2= data.result.times;
                  ...
                  for (var i in tempData2) {
                    if(Array.isArray(tempData2[i])){
                      var m;
                      if(tempData2[i].every(function(item,index){m = index; return item.status != "1"})){}else {
                        var temp = (i == "TDY" ? "今天" : (i == "TOM" ? "明天" : "后天"));
